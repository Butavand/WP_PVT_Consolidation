...
var pvtMainInstructions = {
  ...
  stimulus: 
    ...
    "This part of the task will be subject to data quality controls detecting implausible and inattentive response patterns. " + 
    '<p style="color:#8B0000"><b>Too many errors will terminate the study!</b></p>' +
...
var pvtMainInstructionsAfterFirst = {
  ...
  stimulus: 
  `<div class="instructions" style="max-width:${instructionsWidth}px;">` + 
    "We will repeat the attention task!<br>" +
    'Remember: A <b>stopwatch</b> in the middle of your screen will start counting up very quickly. Whenever that happens, ' + 
      'it is your task to <b>press the space bar</b> as quickly as possible. <b>Please use your dominant hand</b> ' + 
      '(the hand you normally write with). ' +
    "This part of the task will be subject to data quality controls detecting implausible and inattentive response patterns. " + 
    '<p style="color:#8B0000"><b>Too many errors will terminate the study!</b></p>' +
